...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Gray Zone Warfare Wiki",
    description: "Read the Terms of Service for Gray Zone Warfare Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    keywords: [
      'terms of service',
      "Gray Zone Warfare Wiki terms",
      'user agreement',
      'legal terms',
      'usage policy',
    ],
    ...
    openGraph: {
      ...
      title: "Terms of Service - Gray Zone Warfare Wiki",
      description: "Terms and conditions for using Gray Zone Warfare Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Gray Zone Warfare Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Gray Zone Warfare Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Gray Zone Warfare Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Gray Zone Warfare Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Steam game "Gray Zone Warfare". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Map, task, and key guides for Lamang Island</li>
              <li>Weapons, ammo, and ballistics information</li>
              <li>Vendor and faction guides</li>
              <li>Loot routes and extraction strategies</li>
              <li>Patch notes and update summaries</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Gray Zone Warfare Wiki is NOT affiliated with, endorsed by, or associated with
              MADFINGER Games or the official developers of Gray Zone Warfare. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Gray Zone Warfare Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of MADFINGER Games and/or the developers of Gray Zone Warfare. We use such
            ...
            <p>
              ...
              you and Gray Zone Warfare Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@grayzonewarfarewiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@grayzonewarfarewiki.wiki</a>
            </p>
            <p>
