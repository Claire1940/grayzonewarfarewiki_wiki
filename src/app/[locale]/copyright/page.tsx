...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Gray Zone Warfare Wiki',
    description: 'Copyright and intellectual property information for Gray Zone Warfare Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Gray Zone Warfare Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Gray Zone Warfare Wiki',
      description: 'Copyright and intellectual property information for Gray Zone Warfare Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Gray Zone Warfare Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Gray Zone Warfare Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Gray Zone Warfare Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Gray Zone Warfare Developers</strong> - Creators of the Gray Zone Warfare game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Gray Zone Warfare</strong> - Trademark of the game developers</li>
              <li><strong>Gray Zone Warfare Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Gray Zone Warfare Wiki.
            </p>
            ...
            <p>
              ...
              Gray Zone Warfare Wiki<br />
              Email: <a href="mailto:dmca@grayzonewarfarewiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@grayzonewarfarewiki.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Gray Zone Warfare Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Gray Zone Warfare Wiki (grayzonewarfarewiki.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@grayzonewarfarewiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@grayzonewarfarewiki.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@grayzonewarfarewiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@grayzonewarfarewiki.wiki</a>
            </p>
            <p>
