...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Privacy Policy - Gray Zone Warfare Wiki',
    description: 'Gray Zone Warfare Wiki Privacy Policy. Learn how we collect, use, and protect your data when you use our Steam game resource platform. Your privacy matters to us.',
    keywords: [
      'privacy policy',
      'Gray Zone Warfare Wiki privacy',
      'data protection',
      'user privacy',
      'GDPR compliance',
    ],
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Gray Zone Warfare Wiki ("we", "our", or "us") collects minimal information to provide and improve our services.
            ...
            <h2>11. Disclaimer</h2>
            <p>
              Gray Zone Warfare Wiki is an unofficial fan-made website and is not affiliated with, endorsed by, or associated
              with MADFINGER Games or the developers of Gray Zone Warfare. All game content, trademarks, and assets are
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:privacy@grayzonewarfarewiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">privacy@grayzonewarfarewiki.wiki</a>
            </p>
            <p>
